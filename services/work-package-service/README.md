...
```bash
docker pull ghga/work-package-service:11.1.2
```

Or you can build the container yourself from the [`./Dockerfile`](./Dockerfile):
```bash
# Execute in the repo's root dir:
docker build -t ghga/work-package-service:11.1.2 .
```
...
docker run -p 8080:8080 ghga/work-package-service:11.1.2 --help
```
