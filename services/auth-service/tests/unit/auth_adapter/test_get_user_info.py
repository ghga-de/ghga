...
from ...fixtures.utils import MockedOidcApi, create_access_token, mock_userinfo
...
def test_rejects_user_info_with_mismatch_in_sub(oidc: MockedOidcApi):
    """Test that you cannot get user info with a mismatch in subject claims."""
    mock_userinfo(oidc, {**USER_INFO, "sub": "not.john@aai.org"})
