...
async def test_login_with_unregistered_user(
    bare_client: BareClient, oidc: MockedOidcApi
):
...
async def test_login_with_invalid_userinfo(
    ...
    mock_userinfo(oidc, bad_user_info)
...
async def test_login_with_registered_user(bare_client: BareClient, oidc: MockedOidcApi):
...
async def test_login_with_registered_user_and_name_change(
    ...
    mock_userinfo(oidc, changed_user_info)
