...
we decided for **using [JSDoc](https://jsdoc.app/about-getting-started), the [eslint plugin for jsdoc](https://www.npmjs.com/package/eslint-plugin-jsdoc) and [Compodoc](https://compodoc.app/)**
...
The documentation does not have to be deployed anywhere - it can be generated from the codebase and run locally on the developer's machine.
