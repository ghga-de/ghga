...
- The data portal should make full use of semantic tags and aria attributes whenever applicable, and should ensure the implementation of [ADR016](../../adrs/0016-semantic-web-technologies.md)).
