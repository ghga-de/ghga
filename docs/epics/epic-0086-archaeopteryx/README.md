...
Research Data Upload Boxes (RDUBs) have been specified and were implemented in the [Lynx Boreal](../epic-0076-lynx-boreal/README.md) and [Sarcastic Fringehead](../epic-0084-sarcastic-fringehead/README.md) epics on the backend side already.
