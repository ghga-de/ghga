...
Whether the description mentions a coding agent depends on how much of the change it actually
drafted, whichever agent it was:

- **It drafted most of the change**, with people directing and reviewing it: close with
  "Generated by <agent>".
- **It drafted a substantial part**, and people wrote a substantial part too: close with
  "Co-authored by <agent>".
- **Anything less** — suggesting, explaining, reviewing, proofreading, or drafting a few lines
  someone would have written the same way — earns no line at all.

`<agent>` is the tool as it is commonly known (Claude Code, Codex, Copilot, …). Name the model
itself only where that matters.
