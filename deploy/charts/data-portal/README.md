...
| `executable` | Executable name and arguments (will be combined into a shell command) | `""` |
| `executableArgs` |  | `[]` |
...
| `image.repository` | Image repository path (create_charts.py fills this in per member) | `"ghga/data-portal"` |
