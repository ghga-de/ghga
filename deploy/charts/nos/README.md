...
| `executable` | Executable name and arguments (will be combined into a shell command) | `"nos"` |
| `executableArgs` |  | `[]` |
...
| `_topics.accessRequestEvents.topic.name` |  | `"access_request_topic"` |
| `_topics.accessRequestEvents.topic.value` |  | `"access-requests"` |
| `_topics.accessRequestEvents.kafkaUser.operations` |  | `["Read"]` |
| `_topics.ivaStateChangeEvent.topic.name` |  | `"iva_state_changed_topic"` |
| `_topics.ivaStateChangeEvent.topic.value` |  | `"ivas"` |
| `_topics.ivaStateChangeEvent.types` |  | `[{"name": "iva_state_changed_type", "value": "iva_state_changed"}, {"name": "iva_send_code_type", "value": "iva_send_code"}]` |
| `_topics.ivaStateChangeEvent.kafkaUser.operations` |  | `["Read"]` |
...
| `_topics.notificationEvent.kafkaUser.operations` |  | `["Write"]` |
| `_topics.secondFactorRecreatedEvent.topic.name` |  | `"auth_topic"` |
| `_topics.secondFactorRecreatedEvent.topic.value` |  | `"auth"` |
| `_topics.secondFactorRecreatedEvent.types` |  | `[{"name": "second_factor_recreated_type", "value": "second_factor_recreated"}]` |
| `_topics.secondFactorRecreatedEvent.kafkaUser.operations` |  | `["Read"]` |
| `_topics.userEvents.topic.name` |  | `"user_topic"` |
| `_topics.userEvents.topic.value` |  | `"users"` |
| `_topics.userEvents.kafkaUser.operations` |  | `["Read"]` |
...
| `mongodb.dbName` | Database name; combined with dbNamePrefix and injected into config.yaml as db_name. NOTE: mongodb.dbName is the fallback used when the top-level dbName (set per-member, not defaulted here) is empty | `"notification-orchestration"` |
...
| `serviceName` | Logical service name; combined with serviceNamePrefix and injected into config.yaml as service_name | `"nos-consumer"` |
