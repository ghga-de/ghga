...
```
helm install dhfs oci://registry-1.docker.io/ghga/dhfs-chart
```

## Source

Part of the [GHGA monorepo](https://github.com/ghga-de/ghga/tree/main/services/datahub-file-service). See
...
| `executable` | Executable name and arguments (will be combined into a shell command) | `"dhfs"` |
| `executableArgs` |  | `["interrogate"]` |
...
| `image.repository` | Image repository path (create_charts.py fills this in per member) | `"ghga/dhfs"` |
