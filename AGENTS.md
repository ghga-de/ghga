...
- Do not create commits or branches unless explicitly requested. When they are: branch from
  ...
  drafted the change, close the pull request description with "Generated by Claude Code" or
  "Co-authored by Claude Code" instead. Keep that description short and plainly worded, and
  use no emoji outside it.
